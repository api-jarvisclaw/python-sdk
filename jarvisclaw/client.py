...
class LLMClient:
    ...
    def get_balance(self) -> float:
        ...
        # quota is in internal units (500000 = $1)
    ...
    def _get_cost_log_path(self) -> Path:
        """Get path to cost log file."""
    ...
    def _track_cost(self, model: str, path: str, usage: dict) -> None:
        ...
        # Estimate cost from usage (rough: $0.01 per 1K tokens for most models)
        total_tokens = usage.get("total_tokens", 0)
        estimated_usd = total_tokens * 0.00001  # conservative estimate
        ...
        try:
            with open(self._get_cost_log_path(), "a") as f:
    ...
    def _request_raw(self, method: str, path: str, **kwargs) -> requests.Response:
        ...
        for attempt in range(MAX_RETRIES + 1):
            ...
            if resp.status_code == 402:
                ...
                if retry is None:
                    ...
                    try:
                        ...
                        pass
                    raise InsufficientBalanceError(402, "Insufficient balance", body)
                resp = retry
            ...
            # Error handling (final attempt)
            if resp.status_code == 401:
                body = self._safe_json(resp)
                raise AuthenticationError(401, body.get("message", "Unauthorized"), body)
            if resp.status_code == 429:
                body = self._safe_json(resp)
                raise RateLimitError(429, body.get("message", "Rate limit exceeded"), body)
        ...
        if last_error:
            ...
            raise APIError(
                ...
                body.get("message", "Request failed after retries"),
                body,
            )
